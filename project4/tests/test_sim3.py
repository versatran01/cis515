...
class TestSim3(unittest.TestCase):
    def setUp(self):
        self.n_times = 50
        self.B1 = np.array([[5., 0., 0., 3.],  # theta = 0 and lambda = 1
                            [0., 5., 0., 1.],
                            [0., 0., 5., 1.],
                            [0., 0., 0., 0.]], dtype=float)
        ...
        self.B3 = np.array([[0., -0.5, 0.4, 5.],  # theta != 0 and lambda = 0
                            [0.5, 0., 0.5, 2.],
                            [-0.4, -0.5, 0., 1.],
                            [0., 0., 0., 0.]], dtype=float)

        self.B4 = np.array([[3., -0.1, .01, 1.],  # theta != 0 and lambda != 0
                            [0.1, 3., -.01, 2.],
                            [-.01, .01, 3., 9.],
                            [0., 0., 0., 0.]], dtype=float)
    ...
    def test_sim3_exp_SIM3(self):
        nt.assert_almost_equal(sim3_exp_SIM3(self.B1), self.e_B1)
        nt.assert_almost_equal(sim3_exp_SIM3(self.B2), self.e_B2)
        nt.assert_almost_equal(sim3_exp_SIM3(self.B3), self.e_B3)
        nt.assert_almost_equal(sim3_exp_SIM3(self.B4), self.e_B4)
